...
#include <jni.h>
#include "../nativeCode/cube/myCube.h"
...
Java_com_leilei_androidglm_GestureClass_DoubleTapNative(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_leilei_androidglm_GestureClass_ScrollNative(JNIEnv *env, jobject instance,
 ...
 */
JNIEXPORT void JNICALL
Java_com_leilei_androidglm_GestureClass_ScaleNative(JNIEnv *env, jobject instance,
                                                              jfloat scaleFactor) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_leilei_androidglm_GestureClass_MoveNative(JNIEnv *env, jobject instance,
                                                               jfloat distanceX, jfloat distanceY) {
