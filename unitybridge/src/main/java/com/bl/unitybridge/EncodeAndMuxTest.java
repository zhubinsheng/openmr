...
public class EncodeAndMuxTest {
    ...
    private static final int NUM_FRAMES = 3000000;               // two seconds of video
    ...
    static void sendImage(int width, int height) {
        ...
        rgbaBuf.position(0);
//        Log.d("TryOpenGL", "glReadPixels1: " + (System.currentTimeMillis() - star1t));
...
//        Log.d("TryOpenGL", "glReadPixels2: " + (System.currentTimeMillis() - star1t));

//		long end = System.nanoTime();
        reverseBuf(rgbaBuf, width, height);
//        Log.d("TryOpenGL", "glReadPixels3: " + (System.currentTimeMillis() - star1t));

//		Log.d("TryOpenGL", "glReadPixels: " + (end - start));
        saveRgb2Bitmap(rgbaBuf, "", width, height);
//        Log.d("TryOpenGL", "glReadPixels4: " + (System.currentTimeMillis() - star1t));
...
//            bos.flush();
     ...
     * @param surface
     */
    public void testEncodeVideoToMp4(Surface surface) {
        // QVGA at 2Mbps
        mWidth = 640;
        mHeight = 480;
        mBitRate = 1200 * 1024;
     ...
     * @param surface
     */
    private void prepareEncoder(Surface surface) {
        ...
        String outputPath = new File("/data/data/com.bl.unitybridge/files/",
